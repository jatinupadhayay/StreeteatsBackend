      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <div style="text-align: center; margin: 30px 0;">
            <a href="${(process.env.BACKEND_URL && !process.env.BACKEND_URL.includes('localhost')) ? process.env.BACKEND_URL : 'https://streeteatsbackend.onrender.com'}/api/auth/approve-vendor/${vendor._id}" 
